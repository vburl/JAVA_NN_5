 ...
 * I specify that my NeuralNet have 2 input Neurons and 1 output Neurons, as well as 2 hidden layer of 2 neurons each. 
 * Creates a NeuralNet with those specifications, and trains it to approximate the XOR function.
